...
export default function HomePage() {
  ...
  return (
    <div className="w-full overflow-x-hidden bg-white selection:bg-black/10 pb-20 font-sans">
      ...
      {/* 1. HERO BANNER SECTION (PURE WHITE LIQUID GLASS - DOKUNULMADI) */}
      <section className="px-4 md:px-8 pt-4 md:pt-8">
        <div className="relative w-full min-h-[85vh] rounded-[40px] md:rounded-[60px] bg-zinc-50 border border-zinc-200 overflow-hidden flex flex-col items-center justify-center text-center px-6 py-20 shadow-[0_8px_40px_rgba(0,0,0,0.03)]">
          ...
          {/* Liquid animated blobs in the background [cite: 590, 591] */}
          <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-zinc-200/60 blur-[100px] mix-blend-multiply opacity-50 animate-pulse" style={{ animationDuration: '8s' }} />
          <div className="absolute bottom-[-10%] right-[-10%] w-[60vw] h-[60vw] rounded-full bg-zinc-100 blur-[120px] mix-blend-multiply opacity-70 animate-pulse" style={{ animationDuration: '12s' }} />
          
          {/* Frosted Glass Overlay [cite: 591] */}
          ...
          <div className="relative z-10 max-w-4xl mx-auto space-y-8 flex flex-col items-center">
            ...
            {/* Premium Typography applied here [cite: 592, 593] */}
            <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-6xl md:text-[7rem] font-light tracking-tighter text-black leading-[0.9]">
              {t.hero.title} <br />
      ...
      {/* 3. PROCESS SECTION (ESKİSİ GİBİ DOKUNULMADI) [cite: 601, 602, 603] */}
        ...
        <motion.div variants={fadeUpVariant} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}>
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="flex-1 w-full bg-zinc-950 border border-zinc-800 rounded-[40px] p-12 md:p-16 text-center relative overflow-hidden flex flex-col items-center justify-center min-h-[450px] shadow-2xl group">
              <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1634152962476-4b8a00e1915c?q=80&w=2564&auto=format&fit=crop')] bg-cover bg-center opacity-10 mix-blend-overlay"></div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 relative">
        <motion.div variants={fadeUpVariant} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}>
          <div className="p-10 md:p-16 rounded-[40px] bg-zinc-950 border border-zinc-800 shadow-2xl min-h-[500px] flex flex-col justify-center relative overflow-hidden group">
            ...
            {/* Dark/Indigo Background effects */}
            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2564&auto=format&fit=crop')] bg-cover bg-center opacity-20 mix-blend-overlay transition-opacity duration-1000 group-hover:opacity-30"></div>
