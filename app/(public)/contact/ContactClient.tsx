...
import { motion, AnimatePresence } from 'framer-motion'; // YENİ: Animasyon için eklendi
...
export default function ContactPage() {
  ...
  const [errorMessage, setErrorMessage] = useState<string | null>(null); // YENİ EKLENDİ

  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    event.preventDefault();
    setIsSubmitting(true);
    setErrorMessage(null); // Eski hataları temizle
