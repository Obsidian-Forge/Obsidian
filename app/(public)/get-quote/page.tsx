...
function DiscoveryFormContent() {
    ...
    const submitDiscovery = async () => {
        ...
        try {
            ...
            // DÜZELTİLDİ: Artık doğrudan senin core@novatrum.eu adresine gidecek
            await fetch('/api/email', {
                method: 'POST', 
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    type: 'discovery_notification', 
                    email: 'core@novatrum.eu', // info yerine core yapıldı
            ...
            // Alert yerine dilersen buraya state ekleyebilirsin ama şimdilik logluyoruz
        } finally { 
            setLoading(false); 
        }
    };
