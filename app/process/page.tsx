  ...
  const steps = [
    {
      ...
      desc: "I start by deeply analyzing your business goals, target audience, and technical requirements. Together, we define the project scope, feature list, and establish a clear roadmap for success.",
    },
    {
      num: "02",
      title: "UI/UX Design",
      subtitle: "Crafting the experience",
      desc: "Before writing any code, I create wireframes and high-fidelity designs. I focus on modern, minimalist aesthetics and intuitive user journeys that align perfectly with your brand identity.",
    },
    {
      num: "03",
      title: "Development",
      subtitle: "Building the engine",
      desc: "This is where the magic happens. I write clean, scalable, and secure code using modern frameworks like Next.js and Tailwind CSS. The result is a robust architecture that performs effortlessly.",
    },
    {
      num: "04",
      title: "Testing & Refinement",
      subtitle: "Ensuring perfection",
      desc: "I conduct rigorous testing across different devices and browsers. I optimize loading speeds, ensure SEO best practices, and squash any bugs to guarantee a flawless user experience.",
    },
    {
      num: "05",
      title: "Deployment & Handoff",
      subtitle: "Going live",
      desc: "I deploy your project to high-performance global networks like Vercel. Once live, I provide you with all necessary documentation and a smooth handoff, ensuring you are ready to scale.",
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-40 overflow-hidden space-y-40">
        ...
        <FadeUp>
          <div className="text-center space-y-8 max-w-4xl mx-auto mt-10">
            <h1 className="text-5xl md:text-8xl font-medium tracking-tight text-black leading-none">
              How I <br/>
              <span className="text-zinc-400 italic font-light">Work.</span>
            </h1>
        ...
        <FadeUp>
          <div className="text-center pt-20">
            <h3 className="text-3xl md:text-5xl font-medium text-black mb-10 tracking-tight">Ready to start step one?</h3>
